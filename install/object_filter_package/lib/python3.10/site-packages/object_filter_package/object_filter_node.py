...
class YoloZedNode(Node):
    ...
    def postprocess(self, outputs, original_image, conf_threshold=0.2, nms_threshold=0.4):
        """
        ...
        if len(out.shape) == 3:
            ...
            # If shape is (1, 8400, 29), take the first element.
                ...
                return [], [], []
        elif len(out.shape) == 2 and out.shape[0] == 29:
            # If output is already in (8400, 29) shape, assign directly.
            predictions = out.transpose(1,0)
        else:
    ...
    def listener_callback(self, msg):
        ...
        # Ensure format is compatible with OpenCV
